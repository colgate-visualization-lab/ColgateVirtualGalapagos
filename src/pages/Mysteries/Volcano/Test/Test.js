...
import OldVolcanoSlides from "../OldVolcanoSlides";
...
export default function Test() {
  ...
  useEffect(() => {
    ...
    }, 500); //Triggers fade in at the same time as changing the route.
  }, [slideChange]);
  //Fires once, at mount.
  useEffect(() => {
  ...
  return (
    <Fragment>
      <FormControl className={Muiclasses.formControl}>
        ...
        <Select native value={slideChange} onChange={handleDropdownChange}>
