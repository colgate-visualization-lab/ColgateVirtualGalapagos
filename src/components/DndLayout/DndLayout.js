...
export default function DndLayout(props) {
    ...
    if (props.volcano10 == true) {
        ...
        <DndProvider backend={HTML5Backend}>
            ...
            <DndDropTest className={drop1? classes.invisible : `${classes.drop} ${classes.drop1}`}  dragIndex={dragIndex} dropIndex={1} correctDrop={() => setDrop1(true)}>1.7 Million Years</DndDropTest>
            <DndDropTest className={drop2? classes.invisible : `${classes.drop} ${classes.drop2}`} dragIndex={dragIndex} dropIndex={2} correctDrop={() => setDrop2(true)}>2.3 Million Years</DndDropTest>
            <DndDropTest className={drop3? classes.invisible : `${classes.drop} ${classes.drop3}`} dragIndex={dragIndex} dropIndex={3} correctDrop={() => setDrop3(true)}>4 Million Years</DndDropTest>
            <DndDropTest className={drop4? classes.invisible : `${classes.drop} ${classes.drop4}`} dragIndex={dragIndex} dropIndex={4} correctDrop={() => setDrop4(true)}>3.3 Million Years</DndDropTest>
            <DndDropTest className={drop5? classes.invisible : `${classes.drop} ${classes.drop5}`} dragIndex={dragIndex} dropIndex={5} correctDrop={() => setDrop5(true)}>700,000 Years</DndDropTest>
            <DndDropTest className={drop6? classes.invisible : `${classes.drop} ${classes.drop6}`} dragIndex={dragIndex} dropIndex={5} correctDrop={() => setDrop6(true)}>700,000 Years</DndDropTest>
        </DndProvider>
        )
    }
}
