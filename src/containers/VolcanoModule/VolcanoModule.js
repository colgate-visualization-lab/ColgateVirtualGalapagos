...
nextSlide() {
    if (this.state.progressIndex == -4) {
        ...
        setTimeout(() => this.audioRef.current.play(), 1)
        console.log("1")
    }
...
hideHidden() {
    ...
    render() {
        const {slideIndex, completed, height, revealHidden, imageChange} = this.state
        if (slideIndex == -4) {
            return (
                <div className={classes.divClass}>
                    <img style={{height: "auto", width: "70%"}} src={logo} />
                    <button onClick={() => this.setState({slideIndex: 17, progressIndex: 17})}>Dev Button</button>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={Exploration01} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={Exploration02} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={Exploration03} onEnded={() => this.reveal()}/>
                    <VolcanoeIframe threeD={Vista1} />
                    <img style={completed} src={Next} className={classes.imgNext} onClick={() => this.nextSlide()} />
                    <img style={completed} src={Back} className={classes.imgBack} onClick={() => this.prevSlide()} />
                </div>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={Exploration04} onEnded={() => this.reveal()}/>
                    <VolcanoeIframe threeD={Vista1} />
                    <img style={completed} src={Next} className={classes.imgNext} onClick={() => this.nextSlide()} />
                    <img style={completed} src={Back} className={classes.imgBack} onClick={() => this.prevSlide()} />
                </div>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={Exploration05} onEnded={() => this.reveal()}/>
                    <VolcanoeIframe threeD={Vista1} />
                    <img style={completed} src={Next} className={classes.imgNext} onClick={() => this.nextSlide()} />
                    <img style={completed} src={Back} className={classes.imgBack} onClick={() => this.prevSlide()} />
                </div>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={terrainMap2} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={volcanoSlider1} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={volcanoCompare360} onEnded={() => this.reveal()}/>
                    <VolcanoeIframe threeD={Vista1} />
                    <img style={completed} src={Next} className={classes.imgNext} onClick={() => this.nextSlide()} />
                    <img style={completed} src={Back} className={classes.imgBack} onClick={() => this.prevSlide()} />
                </div>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={terrainMap3} onEnded={() => this.reveal()}/>
                    <img className={classes.imgClass} src={TerrainMap} />
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={fernandina1} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={santaCruz1} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={terrainMap4} onEnded={() => this.reveal()}/>
                    <img className={classes.imgClass} src={TerrainMap} />
                    <button style={completed} className={`${classes.buttonClass} ${classes.slide4Button}`} onClick={() => this.renderHidden()}>What's A Hypothesis?</button>
                    ...
                    <img style={completed} src={Next} className={classes.imgNext} onClick={() => {this.nextSlide(); this.hideHidden()}} />
                    <img style={completed} src={Back} className={classes.imgBack} onClick={() => {this.prevSlide(); this.hideHidden()}} />
                </div>
            )
        }
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={terrainMapAges1} onEnded={() => this.reveal()}/>
                    <img className={classes.imgClass} src={DnD} />
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={terrainMapAges2} onEnded={() => this.reveal()}/>
                    <img className={classes.imgClass} src={DnDAnswers} />
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={otherVolcanoes1} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={tectonicPlates1} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={platesGame1} onEnded={() => this.reveal()}/>
                    ...
                    <button style={completed} className={`${classes.buttonClass} ${classes.button4}`} onClick={() => this.renderHidden()}>?????</button>
                    <div style={revealHidden} className={classes.popUp}><b>Divergent:</b> two plates move away from each other. <b>Convergent:</b> two plates move toward each other and collide, creating subduction zones or mountain building events. <b>Transform:</b> two plates slide past each other in opposite directions.
                        <img src={XImage} className={classes.slideFiveX} onClick={() => this.hideHidden()}/>
                    </div> 
                    <img style={completed} src={Next} className={classes.imgNext} onClick={() => {this.nextSlide(); this.hideHidden()}} />
                    <img style={completed} src={Back} className={classes.imgBack} onClick={() => {this.prevSlide(); this.hideHidden()}} />
            ...
            return (
                <div className={classes.divClass}>
                    {/* Slide needs changes */}
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={tectonicPlates2} onEnded={() => this.reveal()}/>
                    <img className={classes.imgClass} src={tectonicPlatesMap} />
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={southAmerica1} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={terrainMap6} onEnded={() => this.reveal()}/>
                    <img className={classes.imgClass} src={TerrainMap} />
                    <button style={completed} className={`${classes.buttonClass} ${classes.button4}`} onClick={() => this.nextSlide()}>Eruption Dates</button>
                    <img style={completed} src={Back} className={classes.imgBack} onClick={() => this.prevSlide()} />
                </div>
            )
        }
            ...
            return (
                <div className={classes.divClass} ref={this.randomRef}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={plumePlacement1} onEnded={() => {this.reveal();}}/>
            ...
            return (
                <div className={classes.divClass} ref={this.headerRef}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={plumePlacement1} onEnded={() => {this.reveal(); this.updateDimensions()}}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={plumeNo1} onEnded={() => this.reveal()}/>
                    <img className={classes.imgClass} src={imageChange} />
                    <h1 style={{zIndex: "1", position: "absolute", top: "0", left: "0"}}>That was wrong Dummy! Click back and try again.</h1>
                    <button style={completed} className={`${classes.buttonClass} ${classes.slide67one}`} onClick={() => {this.setState({slideIndex: 17, imageChange: TerrainOvalWrong}); window.addEventListener("resize", this.updateDimensions)}}>Try Again</button>
                    <button style={completed} className={`${classes.buttonClass} ${classes.slide67two}`} onClick={() => this.setState({imageChange: eruptionDates})}>Eruption Dates</button>
                    <button style={completed} className={`${classes.buttonClass} ${classes.slide67three}`} onClick={() => this.setState({imageChange: DnDAnswers})}>Island Ages</button>
                </div>
            )
        }
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={plumeYes1} onEnded={() => this.reveal()}/>
            ...
            return (
                <div className={classes.divClass}>
                    <audio className={classes.audioPlayer} controls controlsList="nodownload" ref={this.audioRef} src={whereNext1} onEnded={() => this.reveal()}/>
                    <img className={classes.imgClass} src={TerrainMap} />
                    <img style={completed} src={Next} className={classes.imgNext} onClick={() => this.nextSlide()} />
                    <img style={completed} src={Back} className={classes.imgBack} onClick={() => this.prevSlide()} />
                </div>
