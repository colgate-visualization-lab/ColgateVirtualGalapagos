...
class NavigationBar {
    ...
    createSidebar(){
        ...
        var sidebar_header = this.setupSideBarHeader()
        var setting_button = this.setupSettingButton()
        side_bar.appendChild(sidebar_header)
        side_bar.appendChild(setting_button)
    }
    ...
    setupBackPackContent(map){
        return createDropDown("component-list", map, "list-unstyled components")
    }
    
    //Placeholder Method - Need to change to incorporate the real fieldbooks later
    setupFieldbook(){
    ...
    setupSettingButton(){ 
        ...
        setting_link.href = "#"
        setting_link.className = "setting"
    ...
    static createDropDown(id, map, class_name) {
    ...
    static createSubList(id, parent_node, map){
